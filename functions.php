...
if (!is_admin()) {
    add_action("wp_enqueue_scripts", "my_fancybox_enqueue", 11);
}
...
function wpguy_category_order_init() {
    ...
    function wpguy_category_order_menu() {
        if (function_exists('add_submenu_page')) {
            add_submenu_page("edit.php?post_type=bookmark", 'Order', 'Order', 'Editor', "wpguy_category_order_options", 'wpguy_category_order_options');
        }
    }
        ...
        if (isset($_GET['page']) && $_GET['page'] == "wpguy_category_order_options") {
            ...
            <script language="JavaScript">
                window.onload = function () {
                    Sortable.create('order', {tag: 'div', onChange: function () {
                            refreshOrder();
                        }});
